...
setuptools.setup(
    name='mewbot-io-desktop-notification',

    python_requires=">=3.10",  # Might be relaxed later

    version=get_version('src/mewbot/io/desktop_notification'),
    ...
    maintainer_email='alex.alexcameron@quicksilver.london',

    license=true_license_text,

    url='https://github.com/mewbotorg/mewbot-io-desktop_notification',
    project_urls={
        "Bug Tracker": "https://github.com/mewbotorg/mewbot-desktop-notification/issues",
    },

    description='A mewbot-io plugin which allows mewbot to produce desktop notifications.',
